...
SELECT x , quote ( substr ( x , 10 , 10 ) ) FROM x ORDER BY x ; 
SELECT x , quote ( substr ( x , 10 , 10 ) ) FROM x WHERE x = 10 ; 
SELECT x , quote ( substr ( x , 10 , 10 ) ) FROM x ; 
...
SELECT x , quote ( x ) , x , quote ( x ) , x , x , x , x , 'y' FROM x , 10 ; 
SELECT * FROM x ; 
SELECT * FROM x 10 ; 
...
INSERT INTO x VALUES ( 10 , NULL , 'y' ) ON CONFLICT ( x ) DO UPDATE SET = x ; 
...
SELECT x , sum ( x ) OVER( ORDER BY x RANGE BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ; 
SELECT x , sum ( x ) OVER( ORDER BY x DESC RANGE BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY x ASC ; 
...
SELECT x , sum ( x ) OVER( RANGE BETWEEN CURRENT ROW AND CURRENT ROW ) FROM x ORDER BY x ; 
SELECT x , sum ( x ) OVER( RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY x ; 
SELECT x , sum ( x ) OVER( RANGE BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING ) FROM x ORDER BY x ; 
SELECT x , sum ( x ) OVER( ROWS BETWEEN CURRENT ROW AND CURRENT ROW ) FROM x ORDER BY 10 , 10 ; 
SELECT x , sum ( x ) OVER( ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 ; 
SELECT x , sum ( x ) OVER( ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 ; 
SELECT x , sum ( x ) OVER( ROWS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 ; 
...
SELECT sum ( x ) OVER( ORDER BY x RANGE BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING ) FROM x ; 
...
SELECT sum ( x ) OVER( ORDER BY x ) FROM x ORDER BY x ; 
SELECT sum ( x ) OVER( ORDER BY x ROWS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY x ; 
SELECT sum ( x ) OVER( ORDER BY x ROWS BETWEEN 10 PRECEDING AND CURRENT ROW ) FROM x ; 
CREATE TABLE x ( x , x INTEGER ) ; 
...
SELECT x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND CURRENT ROW ) FROM x ORDER BY 10 ; 
SELECT x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 ; 
SELECT x , sum ( x ) OVER( ORDER BY x RANGE BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 ; 
SELECT x , sum ( x ) OVER( ORDER BY x DESC RANGE BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 ; 
...
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 PRECEDING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 PRECEDING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , rank () OVER( ORDER BY x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , max ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , min ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) FROM x ORDER BY 10 , 10 , 10 ; 
SELECT x , x , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW ) , sum ( x ) OVER( ORDER BY x , x GROUPS BETWEEN 10 FOLLOWING AND UNBOUNDED FOLLOWING ) FROM x ORDER BY 10 , 10 , 10 ; 
INSERT INTO x VALUES ( 10 , 10 ) ,( 10 , 10 ) ,( 10 , 10 ) ,( 10 , 10 ) ,( 10 , 10 ) ,( 10 , 10 ) ,( 10 , 10 ) ,( 10 , 10 ) ; 
INSERT INTO x VALUES ( NULL , 10 ) ,( NULL , 10 ) ,( NULL , 10 ) ,( 10 , 10 ) ,( 10 , 10 ) ; 
SELECT sum ( x ) OVER( ORDER BY x RANGE BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 ; 
SELECT sum ( x ) OVER( ORDER BY x DESC RANGE BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 ; 
SELECT sum ( x ) OVER( ORDER BY x RANGE BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS FIRST ; 
SELECT sum ( x ) OVER( ORDER BY x RANGE BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS LAST ; 
SELECT sum ( x ) OVER( ORDER BY x DESC RANGE BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS FIRST ; 
SELECT sum ( x ) OVER( ORDER BY x DESC RANGE BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS LAST ; 
SELECT sum ( x ) OVER( ORDER BY x NULLS FIRST RANGE BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS FIRST ; 
SELECT sum ( x ) OVER( ORDER BY x NULLS LAST RANGE BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS LAST ; 
SELECT sum ( x ) OVER( ORDER BY x NULLS FIRST ROWS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS FIRST ; 
SELECT sum ( x ) OVER( ORDER BY x NULLS LAST ROWS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS LAST ; 
SELECT sum ( x ) OVER( ORDER BY x DESC NULLS LAST ROWS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS FIRST ; 
SELECT sum ( x ) OVER( ORDER BY x DESC NULLS LAST ROWS BETWEEN 10 PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS LAST ; 
SELECT sum ( x ) OVER( ORDER BY x ASC NULLS LAST RANGE BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS LAST ; 
SELECT sum ( x ) OVER( ORDER BY x DESC NULLS FIRST RANGE BETWEEN UNBOUNDED PRECEDING AND 10 FOLLOWING ) FROM x ORDER BY 10 NULLS LAST ; 
...
SELECT x , sum ( x ) OVER( ORDER BY x RANGE BETWEEN 10 PRECEDING AND 10 PRECEDING ) FROM x ; 
SELECT x , sum ( x ) OVER( ORDER BY x RANGE BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ; 
SELECT x , sum ( x ) OVER( ORDER BY x RANGE BETWEEN 10 PRECEDING AND 10 PRECEDING EXCLUDE NO OTHERS ) FROM x ; 
SELECT x , sum ( x ) OVER( ORDER BY x RANGE BETWEEN 10 FOLLOWING AND 10 FOLLOWING EXCLUDE NO OTHERS ) FROM x ; 
SELECT x , max ( x ) OVER( ORDER BY x RANGE BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ; 
SELECT x , min ( x ) OVER( ORDER BY x RANGE BETWEEN 10 FOLLOWING AND 10 FOLLOWING ) FROM x ; 
SELECT x , max ( x ) OVER( ORDER BY x RANGE BETWEEN 10 PRECEDING AND 10 PRECEDING ) FROM x ; 
SELECT x , min ( x ) OVER( ORDER BY x RANGE BETWEEN 10 PRECEDING AND 10 PRECEDING ) FROM x ; 
